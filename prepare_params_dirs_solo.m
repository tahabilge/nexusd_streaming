function [dir_name, ipg_1_type, ipg_1_req_stim_status, orig_stim_group, ...
    ...
    % ipg_1_type: Striatal or cortical IPG.
    ...
    [subj_code, visit_code, visit_day, session_task, ...
        ipg_1_type, ipg_1_req_stim_status, orig_stim_group,...
    ...
    % doesn't exist yet.
    current_info = [subj_code '_' visit_code '_' visit_day '_'];
...
function [subj_code, visit_code, visit_day, session_task, ipg_1_type, ...
    ipg_1_req_stim_status, orig_stim_group, exp_stim_group] = ...
    ...
    prompt = {'Subject Code: (e.g., pcs01)', 'Visit Code: (e.g., eegpresb)', ...
        'Day: (e.g., 1)', 'Task: (e.g., msiton)', ...
        'IPG Type: (Striatal or Cortical)', 'IPG Req Stim: (On or Off)', ...
        'Original Stim Group: (A=1 to D=4)', 'Experimental Stim Group: '};

    dlg_title = 'PC+S Info';
    num_lines = 1;
    defaultans = {'test','eeg', '1', 'notask', 'Striatal', 'On', '2', '4'};
    ...
    ipg_1_req_stim_status = answer{6}; ipg_1_req_stim_status = ...
        lower(ipg_1_req_stim_status);   
    orig_stim_group = str2double(answer{7});
    exp_stim_group = str2double(answer{8});
